...
#### Revize a rozpracované změny

Pokud má kolekce zapnuté revize, v horní navigaci záznamu je karta **Revize**.

- Vlevo je **časová osa změn** s live verzí, publikacemi a historickými revizemi.
- Pokud upravujete publikovaný záznam, zobrazí se nahoře zvlášť **rozpracované změny**.
- Kliknutím na položku otevřete její snapshot.
- Tlačítkem **Porovnat** vyberete druhou verzi a vpravo se zobrazí diff po sekcích a polích.
- Tlačítko **Obnovit revizi** nikdy nepřepíše live verzi přímo. U publikovaného záznamu se starší revize nejprve načte do rozpracované verze.
- Rozpracovanou verzi lze z této stránky rovnou **publikovat** nebo **zahodit**.
