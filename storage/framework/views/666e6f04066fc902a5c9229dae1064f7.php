    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 lg:py-40 w-full">
        <div class="max-w-3xl">
            ...
            <p class="text-lg sm:text-xl text-gray-300 leading-relaxed max-w-2xl mb-10">
                <?php echo e(__('miPress je otevřený CMS navržený pro ty, kdo chtějí flexibilitu Laravelu bez kompromisů. Strukturovaný obsah, bloková editace a vícejazyčnost hned po instalaci.')); ?>

            </p>

            
            <div class="flex flex-wrap gap-4">
                <a href="<?php echo e(url('/mpcp')); ?>"
        ...
        <div class="absolute right-8 top-1/2 -translate-y-1/2 hidden xl:flex flex-col gap-3 opacity-60">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = [['php', 'PHP 8.3'], ['mysql', 'MySQL 8'], ['node', 'Node 22']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$icon, $label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="flex items-center gap-3 bg-gray-900/60 border border-gray-700/50 rounded-xl px-4 py-3 backdrop-blur-sm">
                <span class="font-mono text-xs text-blue-400">// <?php echo e($label); ?></span>
            </div>
...
<section class="bg-white dark:bg-gray-950 py-24 sm:py-32">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-16">
            <span class="text-blue-600 dark:text-blue-400 text-sm font-semibold font-mono uppercase tracking-widest"><?php echo e(__('Možnosti')); ?></span>
            <h2 class="mt-3 text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white leading-tight"><?php echo e(__('Vše, co váš web potřebuje')); ?></h2>
            <p class="mt-4 text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto"><?php echo e(__('Navrženo s důrazem na vývojářský komfort a obsahovou svobodu. Bez zbytečného omezování.')); ?></p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $feature): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div class="group relative bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl p-8 hover:border-blue-300 dark:hover:border-blue-700 hover:bg-blue-50/50 dark:hover:bg-blue-950/30 transition-all duration-200">
                <div class="text-3xl mb-4"><?php echo e($feature['icon']); ?></div>
                <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2"><?php echo e($feature['title']); ?></h3>
                <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed"><?php echo e($feature['desc']); ?></p>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
    </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            ...
            <div class="text-white">
                <div class="text-3xl sm:text-4xl font-bold font-mono mb-1"><?php echo e($stat['value']); ?></div>
                <div class="text-blue-200 text-sm"><?php echo e($stat['label']); ?></div>
            </div>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
        </div>
    </div>
...
<section class="bg-white dark:bg-gray-950 py-24 sm:py-32">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-end justify-between mb-12">
            <div>
                <span class="text-blue-600 dark:text-blue-400 text-sm font-semibold font-mono uppercase tracking-widest"><?php echo e(__('Blog')); ?></span>
                <h2 class="mt-3 text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white leading-tight"><?php echo e(__('Nejnovější příspěvky')); ?></h2>
            </div>
            <?php
                $articlesCollection = \MiPressCz\Core\Models\Collection::where('handle', 'articles')->first();
            ?>
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($articlesCollection): ?>
            <a href="<?php echo e(url('/articles')); ?>" class="hidden sm:inline-flex items-center gap-1 text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors">
                <?php echo e(__('Všechny příspěvky')); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <article class="group flex flex-col bg-gray-50 dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden hover:border-blue-300 dark:hover:border-blue-700 transition-all duration-200">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->featured_image_id ?? null): ?>
...
<?php $component = Awcodes\Curator\View\Components\Glider::resolve(['media' => $article->featured_image_id,'width' => '600','height' => '338'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
                ...
                <div class="flex flex-col flex-1 p-6">
                    ...
                    <time class="text-xs text-gray-500 dark:text-gray-500 mb-3 font-mono">
                        <?php echo e($article->published_at->translatedFormat('j. F Y')); ?>
                    ...
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-2 leading-snug group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors line-clamp-2">
                        <a href="<?php echo e(url($article->uri)); ?>"><?php echo e($article->title); ?></a>
                    </h3>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($article->meta_description ?? null): ?>
                    <p class="text-sm text-gray-600 dark:text-gray-400 leading-relaxed flex-1 line-clamp-3"><?php echo e($article->meta_description); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    <a href="<?php echo e(url($article->uri)); ?>"
...
<section class="relative overflow-hidden bg-gradient-to-br from-blue-600 to-blue-800 py-24 sm:py-32">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h2 class="text-4xl sm:text-5xl font-bold text-white leading-tight mb-6"><?php echo e(__('Připraveni začít?')); ?></h2>
        <p class="text-lg text-blue-200 max-w-2xl mx-auto mb-10">
            <?php echo e(__('Stáhněte si miPress, nainstalujte a spusťte svůj web ještě dnes. Otevřený zdrojový kód, žádné licenční poplatky.')); ?>
        ...
        <div class="flex flex-wrap items-center justify-center gap-4">
            <a href="<?php echo e(url('/mpcp')); ?>"
               class="inline-flex items-center gap-2 bg-white text-blue-700 hover:bg-blue-50 font-semibold px-8 py-4 rounded-xl transition-colors shadow-lg">
                <?php echo e(__('Otevřít administraci')); ?>
