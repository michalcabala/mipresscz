<div id="mason-preview-container">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(empty($blocks)): ?>
        <div
            ...
            "
        >
            <?php echo e(__('mason::mason.preview.placeholder')); ?>
    ...
    <?php else: ?>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $blocks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $block): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
            <div
                class="mason-block"
                draggable="true"
                data-block-index="<?php echo e($block['index']); ?>"
                data-brick-id="<?php echo e($block['id']); ?>"
                data-config="<?php echo e(json_encode($block['config'])); ?>"
                data-total-blocks="<?php echo e(count($blocks)); ?>"
            >
                <div class="mason-block-controls">
                    ...
                    >
                        ...
                        >
                            <title>
                                <?php echo e(__('mason::mason.preview.move_up')); ?>
                    ...
                    >
                        ...
                        >
                            <title>
                                <?php echo e(__('mason::mason.preview.move_down')); ?>
                    ...
                    <button
                        class="mason-block-btn"
                        title="<?php echo e(__('mason::mason.preview.add')); ?>"
                        data-action="add"
                    >
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                        ...
                        >
                            <title>
                                <?php echo e(__('mason::mason.preview.add')); ?>
                    ...
                    >
                        ...
                        >
                            <title>
                                <?php echo e(__('mason::mason.preview.edit')); ?>
                    ...
                    >
                        ...
                        >
                            <title>
                                <?php echo e(__('mason::mason.preview.delete')); ?>
            ...
            <div
                class="mason-drop-zone"
                data-drop-index="<?php echo e($block['index'] + 1); ?>"
            ></div>
...
<?php /**PATH C:\laragon\www\mipresscz\vendor\awcodes\mason\resources\views/iframe-preview-content.blade.php ENDPATH**/ ?>