...
<?php else: ?>
    <div class="fmm-builder-card">
        ...
        <div class="fmm-builder-header">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($autoSave): ?>
        ...
        <div
            ...
            id="fmm-root-list"
            x-data="menuSortable($wire, <?php echo e($maxDepth ?? 'null'); ?>)"
        >
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoop($loop->index); ?><?php endif; ?>
                <?php echo $__env->make('filament-menu-manager::components.menu-item', ['item' => $item, 'depth' => 0, 'index' => $idx], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($deletingItemId): ?>
            ...
            >
                ...
                >
                    ...
                    <div style="padding: 1rem 1.5rem; background: var(--fmm-handle-bg); border-top: 1px solid var(--fmm-border); display: flex; justify-content: flex-end; gap: 0.75rem;">
                        ...
                        <button 
                            type="button" 
                            wire:click="removeItem(<?php echo e($deletingItemId); ?>)"
...
<?php /**PATH C:\laragon\www\mipresscz\vendor\notebrainslab\filament-menu-manager\resources\views/livewire/menu-builder.blade.php ENDPATH**/ ?>